      ...
      <div className="flex flex-col lg:flex-row gap-12">
          ...
          <nav className="space-y-8 sticky top-24">
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="#introduction" className="text-[var(--text-primary)] hover:text-[var(--neon-green)] transition-colors">Introduction</a></li>
                <li><a href="#authentication" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">Authentication</a></li>
                <li><a href="#rate-limits" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">Rate Limits</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-xs font-bold uppercase tracking-widest text-[var(--neon-purple)] mb-4">Endpoints</h3>
              <ul className="space-y-3 text-sm">
                <li><a href="#calculate-route" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors font-mono">POST /v1/routes</a></li>
                <li><a href="#vehicle-types" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">Vehicle Models</a></li>
              </ul>
            </div>
          </nav>
        </aside>
        ...
        <main className="flex-1 max-w-3xl">
          <section id="introduction" className="mb-16">
            <h1 className="text-4xl font-extrabold text-[var(--text-primary)] mb-6 tracking-tight">API Documentation</h1>
          ...
          <section id="authentication" className="mb-16">
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">Authentication</h2>
            ...
            <div className="glass-panel p-4 font-mono text-sm text-[var(--text-primary)] mb-4 bg-[var(--surface-glass)]">
              Authorization: Bearer YOUR_API_KEY
            </div>
          ...
          <section id="calculate-route" className="mb-16">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-[var(--text-primary)] font-mono">/v1/routes</h2>
            </div>
            <p className="text-[var(--text-secondary)] mb-8">
              Calculates greenest, fastest, and shortest routes between origin and destination.
            </p>

            <h3 className="text-sm font-bold text-[var(--text-primary)] uppercase mb-4 tracking-wider">Request Body</h3>
              ...
              <table className="w-full text-sm text-left border-collapse">
                ...
                <tbody className="text-[var(--text-secondary)]">
                  ...
                  <tr className="border-b border-[var(--border-subtle)]">
                    ...
                    <td className="py-4">Vehicle type: <code className="text-[var(--text-primary)]">petrol</code>, <code className="text-[var(--text-primary)]">ev</code>, <code className="text-[var(--text-primary)]">diesel</code>.</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            {/* Code Examples */}
            <div className="glass-panel overflow-hidden bg-[var(--surface-glass)]">
              ...
              <div className="p-4 bg-black/40 dark:bg-black/40 font-mono text-sm leading-relaxed overflow-x-auto">
                <pre className="text-green-50/90 dark:text-green-50/90">
