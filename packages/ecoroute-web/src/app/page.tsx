  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mt-8">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-400">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          ...
          <Link href="/compare" className="btn-glass text-base flex items-center justify-center gap-2">
            Try Playground
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-4 mt-20 max-w-5xl w-full text-left px-4 pb-12">
        <div className="glass-panel p-6 border-glow-hover">
          ...
          <h3 className="text-lg font-bold mb-2 text-white">Hyper-Accurate Topology</h3>
        ...
        <div className="glass-panel p-6 border-glow-hover">
          ...
          <h3 className="text-lg font-bold mb-2 text-white">Multi-Model Engines</h3>
        ...
        <div className="glass-panel p-6 border-glow-hover">
          ...
          <h3 className="text-lg font-bold mb-2 text-white">Drop-in REST API</h3>
